...
import ths.commons.exception.ServiceNotFoundException;
import ths.commons.exception.ClassInstantiationException;
import ths.commons.io.StreamUtils;
...
public class ClassLoaderUtils {
    ...
    public static Class<?> loadServiceClass(String serviceId, ClassLoader classLoader) throws ClassNotFoundException {
        ...
        try {
            serviceClassName = StringUtils.trimToEmpty(StreamUtils.readText(istream, "UTF-8", true));
        } catch (IOException e) {
    ...
    public static URL[] whichClasses(String className) {
        return getResources(ClassUtils.getResourceNameForClass(className));
    }
    ...
    public static URL[] whichClasses(String className, Class<?> referrer) {
        return getResources(ClassUtils.getResourceNameForClass(className), referrer);
    }
    ...
    public static URL[] whichClasses(String className, ClassLoader classLoader) {
        return getResources(ClassUtils.getResourceNameForClass(className), classLoader);
    }
    ...
    public static URL whichClass(String className) {
        return getResource(ClassUtils.getResourceNameForClass(className));
    }
    ...
    public static URL whichClass(String className, Class<?> referrer) {
        return getResource(ClassUtils.getResourceNameForClass(className), referrer);
    }
    ...
    public static URL whichClass(String className, ClassLoader classLoader) {
        return getResource(ClassUtils.getResourceNameForClass(className), classLoader);
    }
}
