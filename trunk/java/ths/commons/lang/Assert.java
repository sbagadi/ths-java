package ths.commons.lang;

import static ths.commons.lang.Assert.ExceptionType.*;

import ths.commons.exception.UnexpectedFailureException;
import ths.commons.exception.UnreachableCodeException;
 ...
 * <li>Assertion的出错信息不是给最终用户看的，因此没必要写得过于详细，更没必要考虑国际化的问题，以至于浪费CPU的时间。<br>
 * 例如下面的语句是要避免的：
 * <br>
 * assertTrue(type instanceof MyType, &quot;Unsupported type: &quot; + type);<br>
 * 可以替换成：<br>
 * assertTrue(type instanceof MyType, &quot;Unsupported type: %s&quot;, type);<br>
 * 
