...
import static ths.core.lang.Constants.*;
...
public class ArrayUtils {
	...
	/**
	 * 检查数组中是否用<code>null</code>元素
	 * 
	 * @param array 要检查的数组对象
	 * @return <code>true</code> 数组中没有<code>null</code>元素
	 */
	public static <T> boolean hasNullElements(T[] array) {
		assertTrue(isNotEmpty(array), "array is empty");
	...
	public static <T> T[] removeElements(T[] array, T... values) {
		...
		HashMap<T, MutableInt> occurrences = new HashMap<T, MutableInt>(
				values.length);
		for (T v : values) {
	...
	public static byte[] removeElements(byte[] array, byte... values) {
		...
		HashMap<Byte, MutableInt> occurrences = new HashMap<Byte, MutableInt>(
				values.length);
		for (byte v : values) {
	...
	public static short[] removeElements(short[] array, short... values) {
		...
		HashMap<Short, MutableInt> occurrences = new HashMap<Short, MutableInt>(
				values.length);
		for (short v : values) {
	...
	public static int[] removeElements(int[] array, int... values) {
		...
		HashMap<Integer, MutableInt> occurrences = new HashMap<Integer, MutableInt>(
				values.length);
		for (int v : values) {
	...
	public static long[] removeElements(long[] array, long... values) {
		...
		HashMap<Long, MutableInt> occurrences = new HashMap<Long, MutableInt>(
				values.length);
		for (long v : values) {
	...
	public static float[] removeElements(float[] array, float... values) {
		...
		HashMap<Float, MutableInt> occurrences = new HashMap<Float, MutableInt>(
				values.length);
		for (float v : values) {
	...
	public static double[] removeElements(double[] array, double... values) {
		...
		HashMap<Double, MutableInt> occurrences = new HashMap<Double, MutableInt>(
				values.length);
		for (double v : values) {
	...
	public static boolean[] removeElements(boolean[] array, boolean... values) {
		...
		HashMap<Boolean, MutableInt> occurrences = new HashMap<Boolean, MutableInt>(
				values.length);
