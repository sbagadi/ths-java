...
public class StringUtils {
    ...
    public static String chomp(String str) {
        ...
        if (last == ESCAPE_LF) {
            if (str.charAt(lastIdx - 1) == ESCAPE_CR) {
                lastIdx--;
            }
        } else if (last != ESCAPE_CR) {
            lastIdx++;
        }
    ...
    public static String chop(String str) {
        ...
        char last = str.charAt(lastIdx);
        if (last == ESCAPE_LF && ret.charAt(lastIdx - 1) == ESCAPE_CR) {
    ...
    public static String normalizeSpace(String str) {
        ...
        return Pattern.compile("\\s+").matcher(trim(str)).replaceAll(" ");
    }
     ...
     * @param string  the CharSequence to check, may be null
     * @param searchStrings the CharSequences to find, may be null or empty
     * @return {@code true} if the CharSequence ends with any of the the prefixes, case insensitive, or both {@code null}
     */
