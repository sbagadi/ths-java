...
public class CharSequenceUtils {
    ...
    /**
     * <p>{@code CharSequenceUtils} instances should NOT be constructed in standard programming. </p>
     *
...
//        }
    ...
    /**
     * <p>Finds the last index in the {@code CharSequence} that matches the specified character.</p>
     *
     * @param cs  the {@code CharSequence} to be processed
     * @param searchChar  the char to be searched for
