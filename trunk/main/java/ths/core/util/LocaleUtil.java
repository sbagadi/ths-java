...
import static ths.core.util.StringUtil.*;
...
import ths.core.util.ClassLoaderUtil;
import ths.core.util.StreamUtil;
import ths.core.i18n.LocaleInfo;
...
public class LocaleUtil {
    ...
    private static Notifier[] getNotifiers() {
        try {
            ...
            LinkedList<Notifier> list = new LinkedList<Notifier>();
    ...
    private static class AvailableLocales {
        private final HashSet<String> AVAILABLE_LANGUAGES = new HashSet<String>();;
        private final HashSet<String> AVAILABLE_COUNTRIES = new HashSet<String>();
