...
import ths.commons.lang.Assert;
import ths.commons.collection.CollectionUtils;
...
public class DomUtil {
    ...
    public static ElementSelector or(final ElementSelector... selectors) {
        return new ElementSelector() {
            ...
            @Override
            public String toString() {
                return "or" + CollectionUtils.asList(selectors);
            }
        };
    }
    ...
    public static ElementSelector and(final ElementSelector... selectors) {
        return new ElementSelector() {
            ...
            @Override
            public String toString() {
                return "and" + CollectionUtils.asList(selectors);
            }
        };
    }
